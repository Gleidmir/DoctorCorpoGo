    ...
    <div className="rounded-2xl bg-zinc-900 p-6 ring-1 ring-zinc-800 shadow-2xl">
      ...
      <div className="mt-6 grid lg:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl bg-zinc-950/60 p-5 ring-1 ring-zinc-800">
          <p className="text-sm font-semibold text-white">Comissão por especialista</p>
          <div className="mt-4 space-y-3">
            {[
              { n: "Mariana", v: 1240, p: 92 },
              { n: "Beatriz", v: 980, p: 74 },
              { n: "Carlos", v: 720, p: 54 },
            ].map((b) => (
              <div key={b.n}>
      ...
      <div className="w-full max-w-[300px] rounded-[2.5rem] bg-zinc-800 p-3 shadow-2xl ring-1 ring-zinc-700">
        <div className="rounded-[2rem] bg-zinc-950 p-1 ring-1 ring-zinc-700">
          <div className="overflow-hidden rounded-[1.75rem] bg-gradient-to-b from-zinc-900 to-zinc-950 px-5 py-5">
            ...
            <p className="text-[10px] uppercase tracking-widest text-zinc-500">DoctorCorpo GO</p>
            <p className="mt-1 text-lg font-extrabold text-white">Agende em 3 toques</p>

            <p className="mt-5 text-[11px] font-semibold text-zinc-400">1. Especialista</p>
            <div className="mt-2 flex gap-2 overflow-hidden">
              {[
                { n: "Mariana", a: "M", on: true },
                { n: "Beatriz", a: "B", on: false },
                { n: "Carlos", a: "C", on: false },
              ].map((b) => (
                <div
                  key={b.n}
            ...
            <p className="mt-4 text-[11px] font-semibold text-zinc-400">2. Procedimento</p>
            <div className="mt-2 space-y-1.5">
              {[
                { n: "Clareamento Dental", t: "60 min", v: "R$ 400", on: true },
                { n: "Limpeza (Profilaxia)", t: "30 min", v: "R$ 150", on: false },
                { n: "Aplicação de Botox", t: "30 min", v: "R$ 600", on: false },
              ].map((s) => (
                <div
                  key={s.n}
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row gap-2 rounded-2xl bg-zinc-900/60 p-2 ring-1 ring-zinc-800 max-w-2xl mx-auto">
        {[
          { id: "admin" as const, label: "Painel do Administrador (DoctorCorpo GO)" },
          { id: "client" as const, label: "App do Cliente (DoctorCorpo GO)" },
        ].map((t) => (
          <button
            key={t.id}
            onClick={() => setTab(t.id)}
...
function SignupCard() {
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-lg font-bold text-white">Cadastre sua clínica</p>
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:py-24">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex flex-col items-center justify-center mb-6">
                <div className="relative p-2.5 rounded-full bg-zinc-950/40 ring-1 ring-zinc-800/80 shadow-2xl drop-shadow-[0_0_25px_rgba(20,184,166,0.2)]">
        ...
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div className="flex items-center gap-1.5 sm:gap-2.5">
              ...
              <span className="font-extrabold tracking-tight text-xs sm:text-base whitespace-nowrap">DoctorCorpo <span className="text-amber-500">GO</span></span>
